...
ImageTrans.prototype = {
  //初始化程序
	...
	this._clientWidth = $("body").width()//变换区域宽度
	this._clientHeight = $("body").height();//变换区域高度
	...
	return {
		css3: {//css3设置
			...
			load: function(){
				...
				$$D.setStyle(img, {//居中
				    ...
				    top: ($("body").height() - img.offsetHeight) / 2 + "px",
				    left: ($("body").width() - img.offsetWidth) / 2 + "px",
		...
		filter: {//滤镜设置
			...
			load: function(){
				...
				this._img.style.top = ($("body").height() - this._img.offsetHeight) / 2 + "px";
				this._img.style.left = ($("body").width() - this._img.offsetWidth) / 2 + "px";
			...
			show: function() {
				...
				img.onload = function () {
				    ...
				    //img.style.left = ($(window).width() - img.offsetWidth) / 2 + 'px';
				    //if (img.offsetHeight > 0 && img.offsetHeight < $(window).height()) {
				    //    img.style.top = ($(window).height() - img.offsetHeight) / 2 + 'px';
				    //    img.style.left = ($(window).width() - img.offsetWidth) / 2 + 'px';
				    //} else if (img.offsetHeight >= $(window).height()) {
				    //    img.style.top = '10px';
				    //}
...
/*
				img.onload = function () {
				    ...
				    img.style.top = ($("body").height() - img.offsetHeight) / 2 + "px";
				    img.style.left = ($("body").width() - img.offsetWidth) / 2 + "px";
